...
- Explanation of changes in model choice (if changes occurred between the Segment 2 and Segment 3 deliverables)
  - for segment 3 a nureal network model was added to improve accuracy score since `LogisticRegression` was only 57% accurate. The nureal network uses one hidden layer and six nureons because of three input features for this model. This new model after 100 itterations gives us an accuracy socre of 97%.  
